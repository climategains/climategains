			...
			<ion-content class="ion-padding">
				<div class="bg-black">
					<div class="success banner">
						...
						<h3 class="text-white text-xl font-bold bg-bold">Application Sent</h3>
					</div>
					...
					<ul class="px-4">
						...
						<li class="inline-flex w-full py-3 border-b border-white/20 justify-between">
							<span class="font-bold">Climate Programme</span><span> {{ store.project.country.name }}</span>
						</li>
						<li class="inline-flex w-full py-3 border-b border-white/20 justify-between">
							<span class="font-bold">Project Sector</span><span> {{ store.project.sector }}</span>
						</li>
						<li class="inline-flex w-full py-3 border-b border-white/20 justify-between">
							<span class="font-bold">Date Submitted</span><span> {{ store.project.createdAt }}</span>
						</li>
						<li class="inline-flex w-full py-3 border-b border-white/20 justify-between">
							<span class="font-bold">Steps Completed</span><span> 1. {{ store.project.steps[0].name }}</span>
						</li>
					</ul>
					<div class="w-full flex items-center mt-0 mb-0 bg-white/10">
						<h3 class="text-xl text-white w-full pl-5 my-0 text-center font-bold mx-auto flex items-center py-4">
